...
export default function IndexScreen() {
  return (
    <section className="mx-auto grid min-h-screen w-full max-w-7xl items-center justify-center gap-12 overflow-y-auto overflow-x-hidden px-6 py-16 sm:grid-cols-5">
      ...
      <div className="max-w-screen relative flex items-center justify-center sm:col-span-3 sm:max-w-full sm:justify-start">
        <img
          alt=""
